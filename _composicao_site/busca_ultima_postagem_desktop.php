<?php
	...
	$busca_posts = $pdo->prepare("
		...
		WHERE codUsuario = $codigo_usuario_logado
	...
	if($linha = $busca_posts->fetch(PDO::FETCH_ASSOC)){
		...
		echo"<div class='posts foto-usuario-logado'>
				  ...
				  <div class='container-detalhes-post'>
				       <header class='container-detalhes-dono $classe_cor_post'>
					        <a href='perfil.php?codigo=$codigo_usuario'><img class='fotos-perfil-feed-postagens foto-usuario-logado' src='$foto_usuario' />
